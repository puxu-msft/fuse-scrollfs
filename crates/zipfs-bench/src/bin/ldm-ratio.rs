...
//! [`DEFAULT_SEAL_CHUNK`](zipfs::seal::DEFAULT_SEAL_CHUNK)」的决策依据。
//!
...
use zipfs::core::codec::{compress_with_params, decompress_block, Algo, CompressParams};

/// LDM 起效阈值（8MiB）：块 ≤ 此值时 windowLog ≤23，落在 zstd 默认窗口内，LDM 近乎 no-op。
/// 与 [`CompressParams::sealed`] / [`zipfs::seal::DEFAULT_SEAL_CHUNK`] 的阈值一致。
