...
SIZE=20G MNT=/mnt/zipfs-btrfs ZSTD_LEVEL=3 \
...
```bash
CONDITIONS="C0=/home/xp/src/zipfs/bench/.mnt/c0 A=/mnt/zipfs-btrfs B0=/home/xp/src/zipfs/bench/.mnt/b0" \
...
# A（btrfs）卸载（保留 image）:
MNT=/mnt/zipfs-btrfs sudo -E bash bench/scripts/teardown.sh
# A 卸载并删除 image（显式 DELETE_IMG=1，且校验路径以 .img 结尾、非链接、未被占用）:
MNT=/mnt/zipfs-btrfs IMG=/home/xp/src/zipfs/bench/results/btrfs.img DELETE_IMG=1 \
