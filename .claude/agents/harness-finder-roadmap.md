...
```json
{"candidates":[{"title":"","goal":"","invariant":"","primary_path":"","oracle":"","evidence":"docs/ROADMAP.md:NN 引用原文","touched_paths":[""],"size":"S|M|L","priority":"T0|T1|T2|T3|T4","needs_decision":false,"body_md":"","slug":""}]}
```

（`lane` 字段由 Workflow 在收到你的返回后统一附加为 `"roadmap"`，你不需要输出它。）
