...
- [docs/01-scrollz-design.md](docs/01-scrollz-design.md) —— 实现设计（§1–13 为 2026-06-27 冻结快照）
...
- [docs/archive/06-defect-audit.md](docs/archive/06-defect-audit.md) —— **缺陷审查台账**（两轮审查发现 / 修复 / 判断依据；已核验闭环、归档）
